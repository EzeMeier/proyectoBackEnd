...
export class TikcketsManagerMongo {
  ...
  async getAll() {
    try {
      ...
      console.log(`Error al obtener el ticket ${error.message}`);
  ...
  async addTicket(ticket) {
    try {
      ...
      console.log(`Error al agregar el ticket: ${error.message}`);
  ...
  async getTicketById(id) {
    try {
      ...
      console.log(`Error al obtener el ticket por ID: ${error.message}`);
